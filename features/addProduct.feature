Feature: Add Product to the shopping cart and place successfull order

  Scenario: TC-01 Customer add products in his shopping cart
...
Scenario: TC-02 Customer successfully place order as a guest user
    ...
    And Mike select "Check or Money Order" as payment method and click continue
